            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="about-us-details">
                        ...
                        <p>GetWOBO will respond expeditiously to claims of copyright infringement committed using the GetWOBO website and mobile application (the "Site and Application") that are reported to GetWOBO’s designated email (info@getwobo.com) address, identified in the sample notice below.</p>
                        <p>If you are a copyright owner, or are authorized to act on behalf of one, or authorized to act under any exclusive right under copyright, please report alleged copyright infringements taking place on or through the Site and Application by completing the following Notice of Alleged Infringement and delivering it to GetWOBO’s designated email (info@getwobo.com) address. Upon receipt of the Notice as described below, GetWOBO will take whatever action, in its sole discretion, it deems appropriate, including removal of the challenged material from the Site and Application.</p>
                    </div>
                    <div class="about-us-details">
                        ...
                        <ol>
                            ...
                            <li>Provide your mailing address, telephone number, and, if available, email (info@getwobo.com) address.</li>
                        ...
                        <p>Deliver this Notice, with all items completed, to GetWOBO’s designated email (info@getwobo.com) address please.</p>
