<script>
    $(document).ready(function () {
        $('#content').html('<p>Last Updated: January, 2019</p>\n' +
            ...
            '                                            <li><b>Profile Information.</b> To use certain features within the getWOBO Platform, we may also ask you to complete a profile, which may include your address, phone number, and gender. Certain parts of your profile (like your profile picture, first name, and description) are a part of your public profile page, and will be publicly visible to others.</li>\n' +
            ...
            '                                            <li><b>Communications with getWOBO and other Members.</b> When you communicate with getWOBO or use the getWOBO Platform to communicate with other Members, we collect information about your communication and any information you choose to provide.</li>\n' +
            '                                            <li><b>Address Book Contact Information.</b> You may genuinely enter your contacts’ information manually to access certain features of the getWOBO Platform.</li>\n' +
            '                                            <li><b>Other Information.</b> You may otherwise choose to provide us information when you fill in a form, conduct a search, update or add information to your getWOBO Account, respond to surveys, post to community forums, participate in promotions, or use other features of the getWOBO Platform.</li>\n' +
            '                                        </ol>\n' +
            '                                    </li>\n' +
            '                                </ol>'+
            '</li>'+
        ...
        $('.two').on('click',function (e) {
            ...
            two = '<ol style="list-style-type:disc;">\n' +
                ...
                '                                            <li><b>Location Information.</b> When you use certain features of the getWOBO Platform, we may collect different types of information about your general location (e.g. IP address, zip code) or more specific location information (e.g. precise location from your mobile GPS).</li>\n' +
                '                                            <li><b>Log Data.</b> We automatically collect log information when you use the getWOBO Platform, even if you have not created a getWOBO Account or logged in. That information includes, among other things: details about how you’ve used the getWOBO Platform (including links to third party applications), IP address, access times, hardware and software information, device information, device event information (e.g., crashes, browser type), and the page you’ve viewed or engaged with before or after using the getWOBO Platform.</li>\n' +
                '                                            <li><b>Transaction Information.</b> We collect information related to your transactions on the getWOBO Platform, including the date and time, amounts charged, and other related transaction details.</li>\n' +
                '                                            <li><b>Cookies and Similar Technologies.</b> We use cookies and other similar technologies, such as web beacons, pixels, and mobile identifiers. We may also allow our business partners to use these tracking technologies on the getWOBO Platform, or engage others to track your behavior on our behalf. While you may disable the usage of cookies through your browser settings, we do not change our practices in response to a “Do Not Track” signal in the HTTP header from your browser or mobile application.</li>\n' +
                '                                        </ol>\n' +
                '                                    </li>\n' +
                '                                </ol>\n' +
                '                                <ol style="list-style-type: square;">\n' +
                ...
                '                                            <li><b>Your References.</b> If someone has written a reference for you, it will be published on your getWOBO public profile page.</li>\n' +
                '                                            <li><b>Background Information.</b> For Members, to the extent permitted by applicable laws, getWOBO may obtain the local version of background or registered sex offender checks. We may use your information, including your full name and date of birth, to obtain such reports.</li>\n' +
                '                                            <li><b>Other Sources.</b> To the extent permitted by applicable law, we may receive additional information about you, such as demographic data or fraud detection information, from third party service providers and/or partners, and combine it with information we have about you. For example, we may receive background check results or fraud warnings from service providers like identity verification services for our fraud prevention and risk assessment efforts. We may receive information about you and your activities on and off the getWOBO Platform through partnerships, or about your experiences and interactions from our partner ad networks.</li>\n' +
                '                                        </ol>\n' +
                '                                    </li>\n' +
                '                                </ol>\n' +
                '                            </li>';
        ...
        $('.three').on('click',function (e) {
            ...
            three = '<li><b>HOW WE USE INFORMATION WE COLLECT</b>\n' +
                ...
                '                                            <li>Operate, protect, improve and optimize the getWOBO Platform and experience, such as by performing analytics and conducting research.</li>\n' +
                ...
                '                                            <li>Administer referral programs, rewards, surveys, sweepstakes, contests, or other promotional activities or events sponsored or managed by getWOBO or its third party business partners.</li>\n' +
                '                                        </ol>\n' +
                '                                    </li>\n' +
                '                                </ol>\n' +
                '                            </li>';
        ...
        $('.four').on('click',function (e) {
            ...
            four = '<li style="list-style-type:disc;"><b>SHARING & DISCLOSURE</b>\n' +
                ...
                '                                            <li>If you submit content in a public forum or social media post, or use a similar feature on the getWOBO Platform, that content is publicly visible.</li>\n' +
                '                                        </ol>\n' +
        ...
        $('.five').on('click',function (e) {
            ...
            five = '<ol style="list-style-type:disc;"><li><b>OTHER IMPORTANT INFORMATION</b>\n' +
                ...
                '                                            <li>your activities on the getWOBO Platform may be displayed to your Friends on the getWOBO Platform and/or that third party site;</li>\n' +
                '                                            <li>a link to your public profile on that third party social networking service may be included in your getWOBO public profile;</li>\n' +
                '                                            <li>other getWOBO users may be able to see any common Friends that you may have with them, or that you are a Friend of their Friend if applicable;</li>\n' +
                '                                            <li>other getWOBO users may be able to see any schools, hometowns or other groups you have in common with them as listed on your linked social networking service;</li>\n' +
                ...
                '                                            <li>the publication and display of information that you provide to getWOBO through this linkage is subject to your settings and authorizations on the getWOBO Platform and the third party site.</li>\n' +
                '                                        </ol>\n' +
                '                                    </li>\n' +
                '                                </ol>\n' +
                '                            </li>\n' +
