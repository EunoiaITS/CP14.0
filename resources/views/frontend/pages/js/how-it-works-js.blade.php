<script>
    $(document).ready(function () {
        $('#content').html('<p>This is a people powered community built on trust, with user friendly platform suitable for anyone, anytime, anywhere. All you need to do is to enjoy the ride. Welcome to getWOBO.</p>\n' +
            ...
            '                        <br>\n' +
            '                        <h4 class="about-us-details-title">Have empty seats? OFFERING A RIDE? (for RIDEMATES)</h4>\n' +
            ...
            '                        <br>\n' +
            '                        <h4 class="about-us-details-title">Both Riders and Ridemates are visible to each other through this platform. This is how thing works</h4>\n' +
